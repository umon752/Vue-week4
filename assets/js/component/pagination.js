export default {
    ...
    <ul class="pagination justify-content-center justify-content-md-start">
        <li class="page-item" :class="{'disabled' : !page.has_pre}">
            <a class="page-link d-flex px-2" href="#" aria-label="Previous" @click="$emit('get-product', page.current_page - 1)">
        ...
        <li class="page-item" :class="{'disabled' : !page.has_next}">
            <a class="page-link d-flex px-2" href="#" aria-label="Next" @click="$emit('get-product', page.current_page + 1)">
                <span class="material-icons">
                    navigate_next
                </span>
            </a>
